...
def main():
    ...
    parser = argparse.ArgumentParser(description="Day 2 part 1 solver")
    ...
    for game in games_info:
        r = game["red"] > control[0]
        g = game["green"] > control[1]
        b = game["blue"] > control[2]
        rgb = [r,g,b]
        if True not in rgb:
            running_total += game["Game id"]
